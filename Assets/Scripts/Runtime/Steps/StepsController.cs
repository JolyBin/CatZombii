    ...
    public class StepsController
    {
        ...
        private void ShowWinWindow()
        {
            ...
            _winWindow.OnClickContinueButton += () =>
            {
                ...
                // Узел засчитывается и оплачивается ДО выхода: Exit() уводит на карту,
                // а карта собирается из уже обновлённого профиля — иначе игрок увидел бы
                // непройденный узел и старую сумму клубков.
                //
                // Возвращённое число — начисленная награда (docs/10 §15.3). Показать
                // её на самом окне победы пока негде: у UIWinWindow нет ни одного
                // текстового поля, а заводить его — сценовая работа (поправка П5).
                // Игрок видит награду счётчиком клубков на карте.
